...
/**
 * A Collision2d is generated when the {@link com.badlogic.gdx.physics.box2d.Body} of a {@link RigidBody2d} collides with another {@link com.badlogic.gdx.physics.box2d.Body}.
 * The other {@link com.badlogic.gdx.physics.box2d.Body} may be the body of another {@link RigidBody2d} but not always (this can be any other body).
 *
...
public class Collision2d implements Pool.Poolable {
    ...
    /**
     * The {@link io.github.isoteriktech.xgdx.GameObject} collided with. This will be null if the collision was not with a known game object (like an independent {@link com.badlogic.gdx.physics.box2d.Body})
     */
